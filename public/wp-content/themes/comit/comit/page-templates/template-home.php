        ...
        <section class="text-and-form-wrapper">
            <div class="text-and-form-underwrapper">
                <div class="main-text">
                    ...
                    <p>Rufen Sie noch heute an oder kontaktieren Sie uns per <a style="color:#36641C" href="#">E-Mail</a> oder Kontaktformular . Wir machen Ihre Augen zu unserer Herzenssache!</p>
                </div>
                <div class="main-form">
