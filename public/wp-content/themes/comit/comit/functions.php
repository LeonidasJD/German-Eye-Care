...
function services_custom_post_type(){
	$services_args = array(
		...
		'rewrite' => array('slug' => 'vorteile', 'with_front' => false),
...
// CUSTOM STYLE FOR LOGIN PAGE START
...
function getNewLoginPage(){
	...
	<html>
		<div class="web-logo">
		<img src="/wp-content/uploads/2024/06/vector.webp" alt="logo">
		</div>
		
	</html>
	<?php
}
// CUSTOM STYLE FOR LOGIN PAGE END